...
import { EResidence, TAccomodationCard } from '~/schemas/accommodations/accommodations'
...
export default async function PrepareStudentLifeCityPage({ params }: { params: { location: string } }) {
  ...
  const accommodations: TAccomodationCard[] = [
    {
      id: 578,
      properties: {
        ...
        nb_t3: null,
        nb_t4_more: null,
        nb_total_apartments: null,
        owner_name: null,
        owner_url: null,
        postal_code: '06000',
        residence_type: EResidence.ecole,
        slug: 'le-scribe',
      },
    },
    {
    ...
    },
    {
      ...
      properties: {
        ...
        nb_t3: null,
        nb_t4_more: null,
        nb_total_apartments: 130,
        owner_name: null,
        owner_url: null,
        postal_code: '13003',
        residence_type: EResidence.ecole,
        slug: 'studea-euromediterranee-2',
      },
    },
    {
      id: 618,
  ...
  return (
    <div>
      <div className={fr.cx('fr-container')}>
        ...
        <h1>{t('title', { title: location })}</h1>
        <div style={{ backgroundColor: 'white', display: 'flex', position: 'relative', zIndex: 1 }} className={fr.cx('fr-col-md-12')}>
          <div className={fr.cx('fr-col-md-8')} style={{ padding: '3.5rem' }}>
            <h3>{t('subTitle', { title: location })}</h3>
            <p>
              ...
              dolor. Culpa id aliquip do nisi mollit sunt cupidatat fugiat. Nostrud aliquip aute eu. Aliquip reprehenderit laborum
              consectetur mollit aliqua magna consectetur eiusmod ad. Deserunt proident dolore non et commodo dolor. Culpa id aliquip do
              nisi mollit sunt cupidatat fugiat. Nostrud aliquip aute eu.
            </p>
            <div
              style={{
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <span className={fr.cx('fr-text--bold')} style={{ marginLeft: '1.5rem' }}>
                  12000 étudiants
                </span>
              </div>
              <div style={{ backgroundColor: '#dddddd', width: '0.5px' }}></div>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  },
                  {
                    content: (
                      <p>
                        ...
                        duis anim cillum anim. Sit excepteur ad laboris nulla in cupidatat. Incididunt sunt eu sunt officia consequat
                        eiusmod ut. Ea exercitation nostrud ad quis. Consectetur minim consectetur laboris in cillum dolor excepteur ullamco
                        anim.
                      </p>
                    ),
                    label: 'Transports',
          ...
          <div style={{ borderLeft: '1px solid #ddd' }} className={fr.cx('fr-col-md-4')}>
            <div style={{ height: '60%' }}>
              <CityMap bbox={bbox} />
            </div>
      ...
      >
        <div className={fr.cx('fr-container', 'fr-py-6w', 'fr-col-md-12')}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <h1 style={{ color: 'white', marginLeft: 'auto', marginRight: 'auto' }}>Se loger à {location}</h1>
            <div style={{ display: 'flex' }}>
              <div className={fr.cx('fr-col-md-4')}>
                <div style={{ backgroundColor: 'white', padding: '2.5rem', textAlign: 'center' }}>
                  <h4>
                    9 802 logements étudiants <br /> sur la ville de {location}
                  </h4>
              ...
              <div className={fr.cx('fr-col-md-8')} style={{ paddingLeft: '1rem', textAlign: 'center' }}>
                <div style={{ backgroundColor: 'white', height: '100%', padding: '2.5rem' }}>
                  <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                    <div>
            ...
            <div style={{ display: 'flex' }}>
              <div className={fr.cx('fr-col-md-8')} style={{ paddingRight: '1rem' }}>
                <div
                  style={{
                ...
                >
                  <h3>Prix moyen des loyers étudiants à {location}</h3>
                  <div
                    style={{
                  ...
                  >
                    <div style={{ borderBottom: '1px solid #ddd', paddingBottom: '2rem' }}>
                      <div
                        style={{
                          display: 'flex',
                          gap: '1rem',
                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            <Link href="#" className={fr.cx('fr-link')}>
                              ...
                              Consulter les 34 offres <span className={fr.cx('fr-icon-arrow-right-line')} />
                            </Link>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            <Link href="#" className={fr.cx('fr-link')}>
                              {/* TODO -reset margin right on ::before */}
                              Consulter les 42 offres <span className={fr.cx('fr-icon-arrow-right-line')} />
                            </Link>
                          </div>
                        </div>
                      </div>
                  ...
                  <p style={{ margin: 0 }}>
                    <span className={fr.cx('ri-thumb-up-line')}>
                      Un <span className={fr.cx('fr-text--bold')}>plafonnement des loyers est en vigueur à Créteil</span> afin de limiter
                      les abus
                    </span>
                  </p>
                </div>
              ...
              <div className={fr.cx('fr-col-md-4')}>
                <div style={{ backgroundColor: fr.colors.options.beigeGrisGalet._975_75.default, padding: '2.5rem' }}>
                  <div
                    style={{
                      alignItems: 'center',
                      display: 'flex',
      ...
      <div style={{ backgroundColor: '#5858AD' }}>
        ...
        >
          <h1 style={{ color: 'white', marginLeft: 'auto', marginRight: 'auto' }}>Parmi les logements étudiants à {location}</h1>
          ...
          <Button className={styles.whiteButton} priority="tertiary" style={{ marginBottom: '4rem' }}>
            Plus de logements
          </Button>
        </div>
      </div>
