...
import PrepareBudgetAidsTable from '~/app/preparer-mon-budget-etudiant/components/prepare-budget-aids-table'
import PrepareBudgetContentCard from '~/app/preparer-mon-budget-etudiant/components/prepare-budget-content-card'
import PrepareBudgetContentHeader from '~/app/preparer-mon-budget-etudiant/components/prepare-budget-content-header'
import PrepareBudgetRedirectionCard from '~/app/preparer-mon-budget-etudiant/components/prepare-budget-redirection-card'
import PrepareBudgetSimulateAidsCard from '~/app/preparer-mon-budget-etudiant/components/prepare-budget-simulate-aids-card'
