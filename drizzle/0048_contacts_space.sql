...
CREATE TABLE "contact_request" (
	...
	CONSTRAINT "contact_request_user_id_accommodation_id_unique" UNIQUE("user_id","accommodation_id")
);
...
ALTER TABLE "contact_request" ADD CONSTRAINT "contact_request_accommodation_id_accommodation_id_fk" FOREIGN KEY ("accommodation_id") REFERENCES "public"."accommodation"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "contact_request_accommodation_id_idx" ON "contact_request" USING btree ("accommodation_id");--> statement-breakpoint
